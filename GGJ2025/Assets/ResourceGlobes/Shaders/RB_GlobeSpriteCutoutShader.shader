...
#pragma surface surf NoLighting alpha:blend
	...
	void surf(Input IN, inout SurfaceOutput o) {
		...
		float2 uvmasx = IN.uv_MaskTex.xy + frac(_Time.y * float2(_LAYER_1_SCROLL_X,_LAYER_1_SCROLL_Y));
        float2 uv2 = IN.uv_MainTex2.xy + frac(_Time.y * float2(_LAYER_2_SCROLL_X,_LAYER_2_SCROLL_Y));
        float2 uv3 = IN.uv_MainTex3.xy + frac(_Time.y * float2(_LAYER_3_SCROLL_X,_LAYER_3_SCROLL_Y));
